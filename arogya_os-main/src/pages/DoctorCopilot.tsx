...
const RISK_STYLES: Record<CopilotRiskLevel, string> = {
  LOW: "border-[#BBF7D0] bg-[#DCFCE7] text-[#16A34A] dark:border-[#166534] dark:bg-[#14532D]/40 dark:text-[#4ADE80]",
  MODERATE: "border-[#FDE68A] bg-[#FEF3C7] text-[#D97706] dark:border-[#92400E] dark:bg-[#78350F]/40 dark:text-[#FBBF24]",
  ELEVATED: "border-[#FDE68A] bg-[#FEF3C7] text-[#D97706] dark:border-[#92400E] dark:bg-[#78350F]/40 dark:text-[#FBBF24]",
  HIGH: "border-[#FECACA] bg-[#FEE2E2] text-[#DC2626] dark:border-[#991B1B] dark:bg-[#7F1D1D]/40 dark:text-[#F87171]",
};
...
function RiskBadge({ level }: { level: CopilotRiskLevel }) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-medium border font-sans ${RISK_STYLES[level]}`} aria-label={`Overall risk level: ${RISK_LABELS[level]}`}>
...
const TREND_STYLES: Record<CopilotAnalysis["healthTrend"], string> = {
  Improving: "border-[#BBF7D0] bg-[#DCFCE7] text-[#16A34A] dark:border-[#166534] dark:bg-[#14532D]/40 dark:text-[#4ADE80]",
  Stable: "border-[#E2EAEA] bg-[#F4F8F8] text-[#47585C] dark:border-[#2D3E42] dark:bg-[#1C2C30] dark:text-[#94A3B8]",
  Mixed: "border-[#FDE68A] bg-[#FEF3C7] text-[#D97706] dark:border-[#92400E] dark:bg-[#78350F]/40 dark:text-[#FBBF24]",
  Worsening: "border-[#FECACA] bg-[#FEE2E2] text-[#DC2626] dark:border-[#991B1B] dark:bg-[#7F1D1D]/40 dark:text-[#F87171]",
};
    ...
    trend === "Improving"
      ...
      : trend === "Worsening"
        ...
        : trend === "Mixed"
          ...
          : ArrowRight;
  return (
    <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-medium border font-sans ${TREND_STYLES[trend]}`}>
